  ...
  <div class="profile-page">
    ...
    <div class="page-content">
      ...
      <div class="profile-card animate-fade-in-up">
        ...
        <p class="profile-role">{{ user.position }}</p>
        ...
        <div class="stats-cards">
          <div class="stat-card">
            ...
            <div class="stat-card-value">
              <span class="stat-big text-gradient">{{ user.stats.todayCompleted }}</span>
              <span class="stat-total">/ {{ user.stats.todayTotal }}</span>
            </div>
            <div class="stat-bar">
          ...
          <div class="stat-card">
            ...
            <div class="stat-card-value">
              <span class="stat-big" style="color: var(--color-primary)">{{ user.stats.weekCompleted }}</span>
              <span class="stat-total">/ {{ user.stats.weekTotal }}</span>
            </div>
            <div class="stat-bar">
          ...
          <div class="stat-card stat-card-wide">
            ...
            <div class="stat-card-value">
              <span class="stat-big" style="color: #A78BFA">{{ user.stats.monthCompleted }}</span>
              <span class="stat-total">/ {{ user.stats.monthTotal }}</span>
            </div>
            <div class="stat-bar">
      ...
      <div class="settings-section animate-fade-in-up" style="animation-delay: 200ms">
        ...
        <div class="settings-list">
          ...
          <div class="setting-item">
            <div class="setting-left">
              <span class="material-symbols-rounded setting-icon">dark_mode</span>
...
const todayPercent = computed(() => Math.round((user.stats.todayCompleted / user.stats.todayTotal) * 100))
const weekPercent = computed(() => Math.round((user.stats.weekCompleted / user.stats.weekTotal) * 100))
const monthPercent = computed(() => Math.round((user.stats.monthCompleted / user.stats.monthTotal) * 100))
